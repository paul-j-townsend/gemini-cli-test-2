  ...
  return (
    <Layout>
      ...
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-emerald-900 mb-8">Community Forum</h1>
        
        <div className="text-center mb-8">
          <h2 className="text-xl font-semibold text-emerald-900 mb-4">Welcome to the Veterinary Community</h2>
        ...
        <div className="grid gap-6">
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-start space-x-4">
              <div className="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center">
                <span className="text-emerald-600 font-semibold">DR</span>
              </div>
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  <h3 className="font-semibold text-emerald-900">Dr. Sarah Robertson</h3>
                  <span className="text-sm text-emerald-600">• 2 hours ago</span>
                </div>
                ...
                <div className="flex items-center space-x-4 text-sm text-emerald-600">
                  ...
                  <span>45 views</span>
                  <span>•</span>
                  <span className="text-emerald-600">Endocrinology</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  <h3 className="font-semibold text-emerald-900">Dr. Michael Johnson</h3>
                  <span className="text-sm text-emerald-600">• 4 hours ago</span>
                </div>
                <h4 className="text-lg font-medium text-emerald-900 mb-2">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1">
                <div className="flex items-center space-x-2 mb-2">
                  <h3 className="font-semibold text-emerald-900">Dr. Lisa Martinez</h3>
                  <span className="text-sm text-emerald-600">• 6 hours ago</span>
                </div>
                <h4 className="text-lg font-medium text-emerald-900 mb-2">
        ...
        <div className="mt-8 text-center">
          <button className="text-emerald-600 hover:text-teal-700 font-medium">
