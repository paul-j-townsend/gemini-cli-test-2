    ...
    <Layout>
      ...
      <div className="container-wide py-12">
        <div className="max-w-4xl mx-auto prose prose-lg">
          <h1 className="text-4xl font-bold mb-8 text-emerald-900">Vet Sidekick – Terms and Conditions</h1>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">1. Use of the Site</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">2. Intellectual Property</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">3. Accuracy of Information</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">4. Submissions</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">5. Errors and Changes</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">6. Links to Other Sites</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">7. User-Generated Content</h2>
            <p className="mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">8. Changes to These Terms</h2>
            <p>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold mb-4 text-emerald-900">9. Linking Policy</h2>
            <p className="mb-4">
          ...
          <div className="border-t border-emerald-200 pt-8 mt-12">
            <h3 className="text-xl font-semibold mb-4 text-emerald-900">Contact</h3>
            <p>
              For any questions, email: <a href="mailto:admin@vetsidekick.com" className="text-emerald-600 hover:text-teal-700">admin@vetsidekick.com</a>
            </p>
          </div>
        </div>
      </div>
