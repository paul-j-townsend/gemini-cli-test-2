...
const Podcasts = () => {
  ...
  return (
    <Layout>
      ...
      {/* Hero Section */}
      <section className="relative py-16 lg:py-24 bg-gradient-to-br from-emerald-50 via-white to-emerald-50 overflow-hidden">
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/4 w-72 h-72 bg-emerald-200/30 rounded-full blur-3xl animate-float"></div>
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-teal-200/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
        </div>

        <div className="relative container-wide">
          <div className="text-center animate-fade-in-up">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-emerald-900 mb-6 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
              Expert <span className="text-gradient-primary">Veterinary</span> Podcasts
            </h1>

            <p className="text-lg lg:text-xl text-emerald-700 max-w-3xl mx-auto leading-relaxed mb-8 animate-fade-in-up" style={{ animationDelay: '400ms' }}>
      ...
      {/* Stats Section */}
      <section className="py-12 bg-gradient-to-r from-emerald-500 to-teal-600 animate-fade-in-up">
        <div className="container-wide">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center text-white">
            <div className="animate-scale-in" style={{ animationDelay: '200ms' }}>
              ...
              <div className="text-emerald-100">Expert Episodes</div>
            </div>
            <div className="animate-scale-in" style={{ animationDelay: '400ms' }}>
              <div className="text-3xl lg:text-4xl font-bold mb-2">10K+</div>
              <div className="text-emerald-100">Active Listeners</div>
            </div>
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            {loading ? (
              <div className="text-center py-8">
                ...
                <p className="text-emerald-600 mt-4">Loading episodes...</p>
              </div>
            ) : error ? (
              <div className="text-center py-8">
                  ...
                  <div key={series.name} className="animate-fade-in-up">
                    ...
                    <div className="mb-6">
                      <div className="flex items-center gap-4 mb-3">
                        ...
                        />
                        <h3 className="text-2xl font-bold text-emerald-900">{series.name}</h3>
                        <div className="flex-1 h-px bg-emerald-200"></div>
                        <span className="text-sm text-emerald-600">{series.episodes.length} episode{series.episodes.length !== 1 ? 's' : ''}</span>
                      </div>
                      {series.description && (
                        <p className="text-emerald-700 text-sm leading-relaxed ml-8">
                          {series.description}
                        </p>
                      )}
                    </div>
              ...
              <div className="text-center py-8">
                <p className="text-emerald-600">No episodes available yet.</p>
                <p className="text-sm text-emerald-600 mt-2">Check back soon for new content.</p>
              </div>
            ) : (
              // Single series view
              <div className="animate-fade-in-up">
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-4 mb-3">
                    ...
                    />
                    <h3 className="text-2xl font-bold text-emerald-900">{selectedSeriesFilter}</h3>
                    <div className="flex-1 h-px bg-emerald-200"></div>
                    <span className="text-sm text-emerald-600">{filteredEpisodes.length} episode{filteredEpisodes.length !== 1 ? 's' : ''}</span>
                  </div>
                  {(() => {
      ...
      {/* Call to Action */}
      <section className="py-16 bg-gradient-to-br from-emerald-900 to-teal-800 text-white animate-fade-in-up">
        <div className="container-wide text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-md mx-auto">
            <input
              ...
              className="w-full px-6 py-4 rounded-xl bg-emerald-800 border border-emerald-700 text-white placeholder-emerald-300 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent transition-all duration-200"
            />
