      ...
      <nav className="container-wide">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/podcasts" className="btn-secondary btn-sm whitespace-nowrap !focus:ring-0 !focus:ring-offset-0">
              Listen Now
            </Link>
            <Link href="/about" className="btn-primary btn-sm whitespace-nowrap !focus:ring-0 !focus:ring-offset-0">
              Get Started
            </Link>
          </div>
