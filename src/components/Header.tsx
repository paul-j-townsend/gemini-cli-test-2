      ...
      <nav className="container-wide">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden md:flex items-center space-x-4">
            <Link href="/podcasts" className="btn-secondary btn-sm !focus:ring-0 !focus:ring-offset-0">
              Listen Now
            </Link>
            <Link href="/about" className="btn-primary btn-sm !focus:ring-0 !focus:ring-offset-0">
              Get Started
            </Link>
          </div>
          ...
          <div className="py-4 space-y-2">
            ...
            <div className="pt-4 space-y-3">
              <Link
                href="/podcasts"
                onClick={() => setIsMobileMenuOpen(false)}
                className="block text-center btn-secondary btn-sm w-full animate-slide-in-left !focus:ring-0 !focus:ring-offset-0"
              ...
              <Link
                href="/about"
                onClick={() => setIsMobileMenuOpen(false)}
                className="block text-center btn-primary btn-sm w-full animate-slide-in-left !focus:ring-0 !focus:ring-offset-0"
