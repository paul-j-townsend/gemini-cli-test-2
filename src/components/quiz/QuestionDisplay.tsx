...
export const QuestionDisplay: React.FC<QuestionDisplayProps> = React.memo(({
  ...
  return (
    <div>
      ...
      <div className="bg-gradient-to-r from-emerald-50 to-teal-50 border-l-4 border-emerald-400 p-4 rounded-r-lg mb-6">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h4 className="font-semibold text-emerald-900 text-sm mb-1">CPD Learning Assessment</h4>
            <p className="text-emerald-800 text-xs leading-relaxed">This question tests your understanding of core veterinary principles. Take your time to consider all aspects.</p>
          </div>
        </div>
      </div>

      <h3 className="text-xl lg:text-2xl font-semibold text-emerald-900 mb-6 leading-relaxed border-l-4 border-green-400 pl-4 bg-green-50 py-3 rounded-r-lg">
